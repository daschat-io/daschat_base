""" Daschat channel metaclasses

This module must be used to create any channel plugin to be used with the `Daschat
System`.
...
class ChannelBase(metaclass=ABCMeta):
    """Base class for an channel plugin"""

    request_id: str = cuid.cuid()
    config: Config
    data: dict = {}
    plugin: str = "generic"
    _assignment: str = "channel"
    api_url: str
    api_path: str
    ...
    @abstractmethod
    async def webhook(self, data_in: Any, **kwargs) -> bool:
        """
        Abstract method to process webhook calls from channel provider"""
        pass
    ...
    async def send_msg(
        ...
        **kwargs,
        ...
        """
        Abstract method to send messages coming from Daschat yourself, any of it
        plugins/bots or handsoff app to channel contact"""
        pass
    ...
    async def send_msg_template(
        ...
        **kwargs,
        ...
        """
        Abstract method to send template messages coming from Daschat yourself, any of it
        plugins/bots or handsoff app to channel contact"""
        pass

    @abstractmethod
    async def register_daschat(self, config: ChannelConfig, **kwargs) -> bool:
        """
        Abstract method to send template messages coming from Daschat yourself, any of it
        plugins/bots or handsoff app to channel contact"""
        pass
    ...
    @abstractmethod
    async def health(self, kwargs) -> bool:
        """
        Abstract method to send template messages coming from Daschat yourself, any of it
        plugins/bots or handsoff app to channel contact"""
        pass
    ...
    @abstractmethod
    async def info(self, kwargs) -> bool:
        """
        Abstract method to send template messages coming from Daschat yourself, any of it
        plugins/bots or handsoff app to channel contact"""
        pass
    ...
    @abstractmethod
    async def wallet_balance(self, config: Config, **kwargs) -> bool:
        """
        Get channel account wallet balance"""
        pass

    async def _get_webhook_type(self, type_map: dict, value: str) -> bool:
        """_get_webhook_type from data received from channel app
        ...
        value : str
            Value received from channel app identifying the webhook type
